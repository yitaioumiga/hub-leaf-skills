...
| 名字 | 一句话 |
|---|---|
| [**hub-architect**](./hub-architect/) | 把多个 Skill 组织成 Hub/Leaf 架构，含 7 步安全迁移、4 道回归门禁、证据三角验证 |
...
| **触发回归测试** | 48 条用例、Python 运行器、4 道验收门禁（A/B/C/D） |
| **5 条强规则** | 备份先行、加载隔离、回归放行、证据三角、双根复审 |
